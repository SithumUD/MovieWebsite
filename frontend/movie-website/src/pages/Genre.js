...
import HomeMovieCard from '../components/HomeMovieCard'; // Ensure correct path to your movie card component
import '../components/HomeGenre.css'; // Ensure the correct path to CSS file
